# timoni/modules/tutorial-operator

A [timoni.sh](http://timoni.sh) module for deploying timoni/modules/tutorial-operator to Kubernetes clusters.
...
```shell
timoni -n default apply timoni/modules/tutorial-operator oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni/modules/tutorial-operator
```
