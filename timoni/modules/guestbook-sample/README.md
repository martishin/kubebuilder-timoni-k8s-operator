# timoni/modules/guestbook-sample

A [timoni.sh](http://timoni.sh) module for deploying timoni/modules/guestbook-sample to Kubernetes clusters.
...
```shell
timoni -n default apply timoni/modules/guestbook-sample oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni/modules/guestbook-sample
```
