# timoni/modules/tutorial-operator-crds

A [timoni.sh](http://timoni.sh) module for deploying timoni/modules/tutorial-operator-crds to Kubernetes clusters.
...
```shell
timoni -n default apply timoni/modules/tutorial-operator-crds oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni/modules/tutorial-operator-crds
```
